...
<html>
  ...
  <body onload="startTime()">
	...
	<header>
        ...
        <!--------------------------------------------- Для цивилизованного отдыха ----------------------------------------------------->
		<div class="cat">
		  	<div class="mm02">Цивилизованный отдых</div>

			
			<div class="civil subcat">
				
				<h4 class="subcat__title">Цивилизованный отдых</h4>
				<div class="abroad">
					Еду заграницу
				 	<div class="check c01"></div>
				</div>
				<div class="tour">
					Еду в тур
					<div class="check c02"></div>
				</div>
				<div class="girl">
					Я девушка
				  	<div class="check c12"></div>
				</div>

				<h4 class="subcat__title">Прогноз погоды</h4>
				 <div class="cold">
			 		Холодно</span>
			  		<div class="check c03"></div>
				</div>
				<div class="sun">
			 		Жарко
			 		<div class="check c04"></div>
				</div>
				<div class="rain">
					Дождь
					<div class="check c05"></div>
				</div>

			
				<h4 class="subcat__title">Активный отдых</h4>
				 <div class="swim">
				 	Плавание
				  	<div class="check c06"></div>
				</div>
				<div class="board">
					Cноуборд</span>
					<div class="check c07"></div>
				</div>
			
				<h4 class="subcat__title">Гаджеты</h4>
				<div class="tablet">
					Планшет	
				  	<div class="check c08"></div>
				</div>
				<div class="notebook">
					Ноутбук
					<div class="check c09"></div>
				</div>
				<div class="photo">
					Фотоаппарат
					<div class="check c10"></div>
				</div>

				<h4 class="subcat__title">Дополнительно</h4>
				<div class="medicine">
					Аптечка
					<div class="check c11"></div>
				</div>
			</div>
		</div>   
		<!--------------------------------------------- Отдых на природе ----------------------------------------------------->
		<div class="cat">
			<div class="mm01 visible">Отдых на природе</div>
			
			<div class="cat__nat subcat">
				
				<h4 class="subcat__title">Отдых на природе</h4>	
				<div class="camp">
					C ночевкой
					<div class="check n02"></div>
				</div>
				<div class="girl">
					Я девушка
				  	<div class="check n01"></div>
				</div>
				...
				<h4 class="subcat__title">Прогноз погоды</h4>
				 <div class="cold">
			 		Холодно
			 	 	<div class="check n03"></div>
				 </div>
				 <div class="sun">
					Жарко
					<div class="check n04"></div>
				</div>
				 <div class="rain">
				 	Дождь
				  	<div class="check n05"></div>
				</div>
				...
				<div class="tourism">
					Туризм
					<div class="check n06"></div>
				</div>
				`-->
				<div class="mount">
					Скалолазание
					<div class="check n07"></div>
				</div>
				<div class="swim">
					Плавание
					<div class="check n08"></div>
				</div>
				<div class="fish">
					Рыбалка
					<div class="check n09"></div>
				</div>

				<div class="hunt">
					Охота
					<div class="check n10"></div>
				</div>
				...
				<div class="tablet">
					Планшет
			  		<div class="check n11"></div>
				</div>
				<div class="photo">
					Фотоаппарат
				  	<div class="check n12"></div>
				</div>
				<div class="medicine">
					Аптечка
					<div class="check n13"></div>
				</div>
			</div>
		</div>
	...
	<section>
		<div class="links">
			 <a href="#info" class="btn-info">Как, зачем и почему был сделан этот сайт</a>
			 <a href="#remember" class="btn-remember">Уезжая, не забудь выключить!</a>
		</div>
		...
		<div class="natural-list">
			...
			<article>
				<div class="list">
					...
					<div class="camp_list">  
						<p>Футболка х к.н</p>
						<p>Шорты сменные</p>
						<p>Футболка длинный рукав</p>
						<p>Свитер/реглан</p>
						<p>Штаны</p>
						<p>Носки</p>
						<p>Шлепанцы</p>
						<p>Нижнее белье</p>
						<p>Спальный комплект</p>
					</div> 
					...
					<!-- Плавание -->
					<div class="swim_list">  
						<p>Купальник/ плавки</p>
						<p>Полотенце</p>
						<p>Подводные очки/ маска</p>
					</div>
					
					<!-- Рыбалка -->
					<div class="fish_list">  
						<p>Сапоги резиновые</p>
					</div>
				</div>
				<div class="title">
					<span>Одежда</span>
			...
			<article>
				<div class="list">
					<div class="main">  
						<p>Смартфон + зарядное</p>
					</div>
					
					<!-- Планшет -->
					<div class="tablet_list">
						<p>Планшет + зарядное</p>
					</div>
					
					<!-- Ноутбук -->
					<div class="notebook_list">
						<p>Ноутбук + зарядное</p>
					</div>
					
					<!-- Фотоаппарат -->
					<div class="photo_list">
						<p>Фотоаппарат + зарядное/батарейки</p>
					</div>
				</div>
				<div class="title">
					<span>Гаджеты</span>
			...
			<article>
				<div class="list">
					<div class="main">
						<p>Салфетки влажные</p>
						<p>Расческа</p>
					</div> 
					
					<!-- Ночевка -->
					<div class="camp_list">
						<p>Зубная паста/щетка</p>
						<p>Дезодорант</p>
						<p>Шампунь</p>
						<p>Мыло жидкое</p>
					...
					<!-- Девушка -->
					<div class="girl_list">
						<p>Прокладки/тампоны</p>
						<p>Средство для умывания</p>
						<p>Спонжики</p>
						<p>Зеркальце</p>
						<p>Крема</p>
						<p>Ножнички</p>
						<p>Гигиеническая помада</p>
					</div> 
				</div>
				<div class="title">
					<span>Гигиена</span>
			...
			<article>
				<div class="list">
					...
					<div class="medicine_list">
						...
						<p>Бинт нестерильный</p>
						<p>Спирт медицинский</p>
						<p>Йод</p>
						<p>Фталазол</p>
						<p>Цитрамон</p>
						<p>Аспирин</p>
		...
		<!--------------------------------------------- Список для цивилизованного отдыха ----------------------------------------------------->
		<div class="civil-list">
			<article>
				<div class="list">
					...
					<!-- за границу -->
					<div class="abroad_list">  
						<p>Загранпаспорт</p>
						<p>Виза</p>
						<p>Распечатка брони в гостинице</p>
						<p>Справка о доходах</p>
						<p>Документы в электронном варианте</p>
						<p>Деньги страны</p>
					</div>
				</div>
				<div class="title">
			...
			<article>
				<div class="list">
					...
					<div class="photo_list">
						<p>Фотоаппарат + зарядка/батарейки</p>
					</div>
				</div>
				<div class="title">
					<span>Гаджеты</span>
...
<!--	
	<footer>
		<p>This project is maintained by <a href="https://github.com/aakey">sibotaxis</a></p>
